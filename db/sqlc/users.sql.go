...
const udpateUser = `-- name: UdpateUser :one
UPDATE users
SET 
...
func (q *Queries) UdpateUser(ctx context.Context, arg UdpateUserParams) (User, error) {
	row := q.db.QueryRowContext(ctx, udpateUser,
		arg.HashedPassword,
