...
// UdpateUser mocks base method.
func (m *MockStore) UdpateUser(arg0 context.Context, arg1 sqlc.UdpateUserParams) (sqlc.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UdpateUser", arg0, arg1)
	ret0, _ := ret[0].(sqlc.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UdpateUser indicates an expected call of UdpateUser.
func (mr *MockStoreMockRecorder) UdpateUser(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UdpateUser", reflect.TypeOf((*MockStore)(nil).UdpateUser), arg0, arg1)
}
...
func (m *MockStore) VerifyEmailTx(arg0 context.Context, arg1 sqlc.VerifyEmailTxParams) (sqlc.VerifyEmailTxResult, error) {
	m.ctrl.T.Helper()
